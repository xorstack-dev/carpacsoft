    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-[#003366] to-[#00a3cc] py-24 text-white">
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center mb-16">
              <h2 className="text-2xl font-bold mb-6 text-white">Our Habits</h2>
              <p className="text-sm text-blue-100 max-w-4xl mx-auto text-white">
        ...
        <section className="bg-gradient-to-br from-[#001e4d] to-[#003366] py-24 text-white text-center relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection>
              <h2 className="text-2xl font-bold mb-16 text-white">CarpacSoft is Enabling Digital Transformation, Worldwide</h2>
            </AnimatedSection>
        ...
        <section className="bg-[#001e4d] py-24 text-white text-center">
          <div className="container mx-auto px-4">
            <AnimatedSection>
              <h2 className="text-2xl font-bold mb-8 text-white">Company Background</h2>
